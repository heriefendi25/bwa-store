...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::post('/dashboard/products/gellery/upload', 'DashboardProductController@uploadGallery')
        ->name('dashboard-product-gallery-upload');
    Route::get('/dashboard/products/gellery/delete/{id}', 'DashboardProductController@deleteGallery')
