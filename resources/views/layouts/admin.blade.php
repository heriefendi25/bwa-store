        ...
        <div class="d-flex" id="wrapper" data-aos="fade-right">
            ...
            <div class="border-right" id="sidebar-wrapper">
                <div class="sidebar-heading text-center">
                   <a href="{{ route('admin-dashboard') }}"><img src="/images/admin.svg" style="max-width: 150px" alt="" class="my-4" /></a>
                </div>
                <div class="list-group list-group-flush">
                    ...
                    <a href="{{ route('dashboard-settings-account') }}" class="list-group-item list-group-item-action">Sign Out</a>
                </div>
            </div>
            <!-- /#sidebar-wrapper -->
